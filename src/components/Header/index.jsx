    ...
    return (
        <div className="w-full h-[80px] bg-[#1f1f1f]">
            <ul className="w-full h-full flex justify-evenly items-center text-[#ffffff] text-md">
                ...
                <li><button className="hover:text-[#1ED760] cursor-pointer flex flex-row items-center gap-[5px]" onClick={()=>navigate("values")}><BsFileDiff  /><span>Adicionar Valores</span></button></li>
