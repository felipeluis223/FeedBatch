...
function Header({ onLogout }){
    ...
    return (
        <div className="w-full md:h-[80px] h-[150px] bg-[#1f1f1f]">
            <ul className="w-full h-full flex justify-evenly items-center text-[#ffffff] md:gap-[1] gap-[10px] text-md flex-wrap">
                <li><h2 className="md:block hidden text-[#1ED760] text-xl italic font-bold">FeedBatch</h2></li>
